...
namespace stationeerszoopmod
{
    ...
    public class InventoryManagerPlacementMode
    {
        ...
        public static bool Prefix(InventoryManager __instance)
        {
            ...
            ZoopUtility.isZoopKeyPressed = KeyManager.GetButton(ZoopUtility.ZoopModeKey);
            bool secondary = KeyManager.GetMouseDown("Secondary");
            bool primary = KeyManager.GetMouseDown("Primary");
            bool spec = KeyManager.GetButtonDown(KeyMap.QuantityModifier);
            ...
            if (primary && ZoopUtility.isZooping && !ZoopUtility.isZoopKeyPressed)
            {
                ...
                if (!ZoopUtility.HasError)
                {
                    ...
                    //if ((double) InventoryManager.ConstructionCursor.BuildPlacementTime > 0.0)
                    //{
                        float num1 = 1f;
                        ...
                        ZoopUtility.ActionCoroutine = __instance.StartCoroutine((IEnumerator) method.Invoke(__instance,
                            new Object[]
                            {
                                ...
                                InventoryManager.ConstructionCursor //IS IT space suit raising placement time?
                            })
                        );
                    //}
                    //else
    ...
    {
        public static KeyCode ZoopModeKey = KeyCode.LeftShift;
        ...
        {
            InventoryManagerUsePrimaryComplete.Completion = true; //try not let original InventoryManager.UsePrimaryComplete override completion for Authoring Tool
            ...
            InventoryManagerUsePrimaryComplete.Completion = false;
        ...
        private static void UsePrimaryComplete(InventoryManager IM, Structure item)
        {
            ...
            else
            {
                ...
                DynamicThing occupant1 = IM.ActiveHand.Slot.Occupant;
                // ISSUE: explicit non-virtual call
                structureMessage.ConstructorId = occupant1 != null ? (occupant1.ReferenceId) : 0L;
                DynamicThing occupant2 = IM.InactiveHand.Slot.Occupant;
                // ISSUE: explicit non-virtual call
                ...
                DynamicThing occupant3 = IM.ActiveHand.Slot.Occupant;
